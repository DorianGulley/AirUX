/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 78cb364169e5a6db4721c06478a91dee)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	REVIEWER_AUTH_RATE_LIMITER: RateLimit;
	CREDENTIAL_CREATE_RATE_LIMITER: RateLimit;
	AGENT_REVIEW_CREATE_RATE_LIMITER: RateLimit;
	STREAM: StreamBinding;
	AIRUX_ENVIRONMENT: string;
	AIRUX_APP_ORIGIN: string;
	SUPABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AIRUX_ENVIRONMENT" | "AIRUX_APP_ORIGIN" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY" | "STREAM_SIGNING_JWK" | "STREAM_SIGNING_KEY_ID" | "STREAM_WEBHOOK_SECRET">> {}
}
